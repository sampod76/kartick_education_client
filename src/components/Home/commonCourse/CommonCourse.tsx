...
<h1 className=" text-center text-gray-800 text-[4vw] xl:text-5xl font-medium leading-9 tracking-wider">BUILD A HEALTHIER FOUNDATION FOR LIFELONG LEARNING</h1>
