...
const NavbarPublic = () => {
  ...
  return (
    <div className="w-full lg:w-[80%] mx-auto bg-transparen rounded-b-[50px]  backdrop-blur  block lg:flex  items-center justify-between border-b border-slate-500 px-[2em]">
      <nav
